...
import Web.BookFelix.Repositories.HoaDonRepository;
import Web.BookFelix.Repositories.IBookRepository;
import Web.BookFelix.Repositories.IInvoiceRepository;
import Web.BookFelix.Repositories.IItemInvoiceRepository;
...
public class CartService {
    ...
    public void saveOrder(HttpSession session) {
        ...
        Double totalPrice = getSumPrice(session);
        HoaDon hoaDon = new HoaDon();
        hoaDon.setUserId(userId);
        hoaDon.setTotalPrice(totalPrice);
        hoaDon.setOrderTime(LocalDateTime.now());
